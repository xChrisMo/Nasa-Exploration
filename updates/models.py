...
class NearEarthObject:
    ...
    def serialize(self):
        """Serialize the `NearEarthObject` instance."""
        return {
...
class CloseApproach:
    ...
    def __init__(self, des, cd, dist, v_rel, neo=None):
        """Initialize a `CloseApproach` with the given parameters."""
    ...
    def time_str(self):
        ...
        return f'{obj_time} was when {self.neo.fullname} occurred'  # taking advantage of property method
    ...
    def __repr__(self):
        """Return `repr(self)`, a computer-readable string representation of this object."""
        return (f"CloseApproach(designation={self.designation!r}, time={self.time_str!r}, "
                f"distance={self.distance:.2f}, velocity={self.velocity:.2f})")

    def serialize(self):
        """Serialize the `CloseApproach` instance."""
        return {
