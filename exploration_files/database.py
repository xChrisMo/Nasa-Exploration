...
class NEODatabase:
    ...
    def get_neo_by_designation(self, designation):
        ...
        return self._des_to_neo.get(designation.upper(), None)  #.upper is very subjective, I used it to tidy the output well
    ...
    def get_neo_by_name(self, name):
        ...
        #self.name = name
        #return self.name
        return self.name_to_neo.get(name.upper(), None)
